...
// import { 
//   TrendingUp, ShieldCheck, ChevronLeft, ChevronRight, MapPin, Loader2, X, Play, Heart
// } from 'lucide-react';
...
//   // ✅ NEW: Social Media Like Functionality
...
//           ? currentLikes.filter(id => id !== currentUser.id) // Remove like
//           : [...currentLikes, currentUser.id]; // Add like
...
//     try {
//       await api.put(`/posts/${postId}/like`, { userId: currentUser.id });
//     } catch (error) {
...
//             <Link to="/about" className="text-[#ff4500] border-b-2 border-[#ff4500] pb-1">About Us</Link>
//           </div>
...
//                           {user.name}
//                         </span>
//                         {/* ✅ Level is now displayed under the name */}
//                         <span className="text-[9px] font-bold text-slate-400 uppercase tracking-widest">
//                           Level {user.level || 1}
//                         </span>
//                       </div>
//                     </div>
//                     {/* ✅ Mission count is now highlighted in the orange pill on the right */}
...
//                     {/* ✅ UPGRADED: Instagram-style Like Footer! Removed Discuss & Share */}
//                     <div className="mt-8 flex items-center gap-8">
//                       <button 
//                         onClick={() => handleLike(post._id)}
//                         className={`flex items-center gap-2.5 font-bold text-sm transition-all group ${
//                           hasLiked ? 'text-red-500' : 'text-slate-500 hover:text-slate-900'
//                         }`}
//                       >
//                         <Heart 
//                           size={24} 
