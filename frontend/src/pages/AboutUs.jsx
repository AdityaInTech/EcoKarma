...
import { 
  ...
  Globe, Target, Users, Zap, Heart, Leaf, Shield, Code, MapPin, Sparkles, GraduationCap, Gift, Quote
} from 'lucide-react';
      ...
      <nav className="h-16 bg-white border-b border-slate-100 shrink-0 px-10 flex items-center justify-between shadow-sm z-50">
        ...
        <div className="flex items-center gap-12">
          ...
          <div className="flex items-center gap-4 border-l border-slate-100 pl-8">
            <Link to="/profile" className="w-9 h-9 bg-[#ff4500] text-white rounded-lg flex items-center justify-center font-bold text-sm shadow-sm hover:brightness-110 transition-all cursor-pointer">A</Link>
          </div>
        </div>
      </nav>
