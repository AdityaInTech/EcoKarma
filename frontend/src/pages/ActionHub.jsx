...
//   Video, Image as ImageIcon, Send, MapPin, ShieldCheck, FileText, AlertCircle, User, Phone
// } from 'lucide-react';
...
//     name: '',
//     phoneNo: '',
//     workDetail: '', // Now the short title
//     location: '',
//     workDescription: '', // Now the long description
//     videoProof: null,
//     imageProof1: null,
//     imageProof2: null,
//     isPublic: true 
...
//     alert("Evidence submitted successfully. You can track status and points in your Profile.");
//   };
...
//       {/* 1. TOP NAVBAR */}
//       <nav className="h-16 bg-white border-b border-slate-100 sticky top-0 z-50 px-10 flex items-center justify-between">
...
//                 Impact <span className="text-[#ff4500]">Submission</span>
//               </h1>
...
//                 {/* Work Description (Long Textarea) */}
//                 <div className="space-y-3">
...
//                     <input type="file" accept="video/*" className="absolute inset-0 w-full h-full opacity-0 cursor-pointer" onChange={(e) => setFormData({...formData, videoProof: e.target.files[0]})} required />
//                   </div>
...
//                     <input type="file" accept="image/*" className="absolute inset-0 w-full h-full opacity-0 cursor-pointer" onChange={(e) => setFormData({...formData, imageProof1: e.target.files[0]})} required />
//                   </div>
...
//                     <input type="file" accept="image/*" className="absolute inset-0 w-full h-full opacity-0 cursor-pointer" onChange={(e) => setFormData({...formData, imageProof2: e.target.files[0]})} required />
//                   </div>
//                 </div>
//               </section>
...
import { 
  TrendingUp, ChevronLeft, ChevronRight, 
  Video, Image as ImageIcon, Send, MapPin, ShieldCheck, FileText, AlertCircle, User, Phone, Loader2
} from 'lucide-react';
        ...
        <div className="flex items-center gap-12">
          ...
          <div className="flex items-center gap-4 border-l border-slate-100 pl-8">
            <Link to="/profile" className="w-9 h-9 bg-[#ff4500] text-white rounded-lg flex items-center justify-center font-bold text-sm shadow-sm hover:brightness-110 transition-all cursor-pointer uppercase">
              {/* Dynamically show the user's initial */}
