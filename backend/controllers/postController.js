...
exports.createPost = async (req, res) => {
    try {
        ...
        const baseUrl = `http://localhost:5000/api/posts/approve-email/${newPost._id}`;
        ...
        res.status(201).json({ message: 'EcoKarma post submitted and review email sent!', post: newPost });
